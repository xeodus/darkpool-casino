...
pub mod ephemeral_vault {
    use crate::data::{AccessRevoked, ApproveDelegates, AutoDeposite, 
        CleanupVault, CreateEphemeralVault, DelegateApproved, ExecuteTrade, 
        FundDeposited, RevokeAccess, TradeExecuted, VaultCleanup, VaultCreated, VaultError
    };
